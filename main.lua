...
cmd:option('-lr', 0.00012, 'The learning rate: Any positive decimal value')
...
-- Testing:
cmd:option('-sampleOnly', 0, 'Load a model an start sampling it: 0 | 1')
cmd:option('-modelPath', '', 'The path to load a model an start doing experiments with it: 0 | 1')
cmd:option('-canvasHW', 6, 'Determines the height and width of the canvas on which the samples from the manifold will be drawn: Any positive integer number')
cmd:option('-nSamples', 6, 'The number of samples to be drawn from the prior (z): Any positive integer number')
